# hmpps-approved-premises-manage-a-resident-ui

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-approved-premises-manage-a-resident-ui/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-approved-premises-manage-a-resident-ui)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-approved-premises-manage-a-resident-ui)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-approved-premises-manage-a-resident-ui/security/policy).
